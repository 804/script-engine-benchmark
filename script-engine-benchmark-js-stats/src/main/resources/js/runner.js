...
suite.add('perf#sunspider-3d-morph', function () {
    ...
    .add("Compiled Object Empty Split", function () {
        for (var i = 0; i < 30; i++)
    ...
    .add("Compiled Object Variable Split", function () {
        ...
        setup: function () {
            regexpTests.re = /.*/;
            regexpTests.tmp = regexpTests.generateTestStrings(100);
        }
    })
    ...
    .add("Compiled 12 Char Replace", function () {
        for (var i = 0; i < 50; i++)
            regexpTests.ret = regexpTests.tmp[i].replace(regexpTests.re, "asdfasdfasdf");
    }, {
        setup: function () {
            regexpTests.tmp = regexpTests.generateTestStrings(50);
        }
    })
    .add("Compiled Object Match", function () {
        for (var i = 0; i < 100; i++)
            regexpTests.ret = regexpTests.tmp[i].match(regexpTests.re);
    }, {
        setup: function () {
            regexpTests.re = new RegExp("aaaaaaaaaa", "g");
            regexpTests.tmp = regexpTests.generateTestStrings(100);
        }
    })
    .add("Compiled Object Test", function () {
        for (var i = 0; i < 100; i++)
            regexpTests.ret = regexpTests.re.test(regexpTests.tmp[i]);
    }, {
        setup: function () {
    ...
    .add("Compiled Object Empty Replace", function () {
        for (var i = 0; i < 50; i++)
            regexpTests.ret = regexpTests.tmp[i].replace(regexpTests.re, "");
    }, {
        setup: function () {
    ...
    .add("Compiled Variable Match", function () {
        for (var i = 0; i < 100; i++)
            regexpTests.ret = regexpTests.tmp[i].match(regexpTests.re);
    }, {
        setup: function () {
    ...
    .add("Compiled Variable 12 Char Replace", function () {
        for (var i = 0; i < 50; i++)
            regexpTests.ret = regexpTests.tmp[i].replace(regexpTests.re, "asdfasdfasdf");
    }, {
        setup: function () {
    ...
    .add("Compiled Variable Object Match", function () {
        for (var i = 0; i < 100; i++)
            regexpTests.ret = regexpTests.tmp[i].match(regexpTests.re);
    }, {
        setup: function () {
    ...
    .add("Compiled Capture Match", function () {
        for (var i = 0; i < 100; i++)
            regexpTests.ret = regexpTests.tmp[i].match(regexpTests.re);
    }, {
        setup: function () {
            regexpTests.re = /aa(b)aa/g;
            regexpTests.tmp = regexpTests.generateTestStrings(100);
        }
    })
    .add("Compiled Capture Replace", function () {
        for (var i = 0; i < 50; i++)
            regexpTests.ret = regexpTests.tmp[i].replace(regexpTests.re, "asdfasdfasdf");
    }, {
        setup: function () {
    ...
    .add("Compiled Capture Replace with Capture", function () {
        for (var i = 0; i < 50; i++)
            regexpTests.ret = regexpTests.tmp[i].replace(regexpTests.re, "asdf\\1asdfasdf");
    }, {
        setup: function () {
            regexpTests.tmp = regexpTests.generateTestStrings(50);
        }
    })
    .add("Uncompiled Match", function () {
        for (var i = 0; i < 100; i++)
            regexpTests.ret = regexpTests.tmp[i].match(/aaaaaaaaaa/g);
    }, {
        setup: function () {
            regexpTests.tmp = regexpTests.generateTestStrings(100);
        }
    })
    .add("Uncompiled Object 12 Char Replace", function () {
        for (var i = 0; i < 50; i++)
            regexpTests.ret = regexpTests.tmp[i].replace(new RegExp("aaaaaaaaaa", "g"), "asdfasdfasdf");
    }, {
        setup: function () {
            regexpTests.tmp = regexpTests.generateTestStrings(50);
        }
    ...
    .on('complete', function () {
        writeToFile(
            resultPath + 'results/' + engine + '/results.out',
